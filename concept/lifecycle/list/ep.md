...
| [How-to for lifecycle][lfc howto] | internal |  |


<h1 align="center">List of Lifecycle</h1>

The concept of lifecycle

# List 

- Examples of entity's lifecycle :
   - [project's lifecycle][lfc project whatis]
   - [software's lifecycle][lfc project whatis][project whatis], [software][tool whatis], career, product, …
   - [Human's lifecycle][lfc project whatis][project whatis], [software][tool whatis], career, product, …
   - Career lifecycle
   - Product lifecycle
   - …
