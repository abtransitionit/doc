...
## Bare-Metal Server
- A **Physical Machine** that only has an OS installed, but no Hypervisor nor VM layer
...
# Environment
- By extension of a host: one or more related Hosts in one or more clouds or infrastructures
