...
This project defines a reusable project model (not it physical representation) that can be **instanciated** to create software project

project model is used to **define, plan, execute, document, and finally deliver** a software projects.
